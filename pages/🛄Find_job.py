...
def streamlit_config():
    ...
    # title and position
    st.markdown(f'<h1 style="text-align: center;"> Welcome to <br> Aim🔎Seeker</h1>',
...
with st.sidebar:
    ...
    # option = option_menu(menu_title='', options=['login','Predction','New User','Linkedin Jobs','About_Us'],
    #                      icons=['house-fill', 'database-fill', 'pass-fill','linkedin', 'list-ul',])
